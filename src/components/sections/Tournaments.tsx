...
export default function Tournaments() {
  ...
  return (
    <section
      ...
      className={`${styles.section} bg-brand-white pt-20 text-brand-dark md:pt-24 lg:pt-32`}
    >
      <div className="page-container">
        <div className="grid gap-6 lg:grid-cols-[1.15fr_1fr] lg:gap-16 xl:gap-20">
          <div>
            ...
            <h2
              ...
              className="max-w-150 section-title"
            >
              {content.title}
            </h2>
          </div>
        ...
        <div className={styles.proof}>
          <span aria-hidden="true" className={styles.proofMark} />
          <p className="relative max-w-[24ch] text-[34px] leading-[1.1] font-semibold tracking-[-0.05em] text-balance md:text-5xl lg:text-[64px]">
            {content.proof}
          </p>
        </div>
      </div>
